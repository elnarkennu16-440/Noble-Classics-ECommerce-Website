...
<section class="admin_add_products">
  <form action="" method="post" enctype="multipart/form-data" style="background: linear-gradient(to left, #c27cff, #ffcb82); border-radius: 100px;">
    <h3 style="color: #1d1157; margin-bottom: 20px;">Input Product Item</h3>
